...
@section('title') {{ __('website.Servers Packages') }} @endsection
@section('sub-title') {{ __('website.Servers Packages') }} @endsection
@section('content')
    <!--================ Hero sm Banner start =================-->
    <section class="hero-banner hero-banner--sm mb-30px">
        <div class="container">
            <div class="hero-banner--sm__content">
                <h1>{{ __('website.Servers Packages') }}</h1>
                <nav aria-label="breadcrumb" class="banner-breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('website.index') }}">{{ __('website.Home') }}</a></li>
                        <li class="breadcrumb-item active" aria-current="page">{{ __('website.Servers Packages') }}</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <section class="section-margin">
        <div class="container">
            <div class="section-intro pb-85px text-center">
                <h2 class="section-intro__title">{{ __('website.Packages We Offer for Servers') }}</h2>
                <p class="section-intro__subtitle">{{ __('website.server_packages_description') }}</p>
            </div>
                    ...
                    <div class="row offer-single-wrapper">
                        <div class="col-lg-6 offer-single">
                            <div class="card offer-single__content text-center">
                                ...
                                <h4>{{ __('website.server_packages_feature_name_1') }}</h4>
                                <p>{{ __('website.server_packages_feature_description_1') }}</p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 offer-single">
                            <div class="card offer-single__content text-center">
                                ...
                                <h4>{{ __('website.server_packages_feature_name_2') }}</h4>
                                <p>{{ __('website.server_packages_feature_description_2') }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row offer-single-wrapper">
                        <div class="col-lg-6 offer-single">
                            <div class="card offer-single__content text-center">
                                ...
                                <h4>{{ __('website.server_packages_feature_name_3') }}</h4>
                                <p>{{ __('website.server_packages_feature_description_3') }}</p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 offer-single">
                            <div class="card offer-single__content text-center">
                                ...
                                <h4>{{ __('website.server_packages_feature_name_4') }}</h4>
                                <p>{{ __('website.server_packages_feature_description_4') }}</p>
                            </div>
                        </div>
                    </div>
    ...
    <section class="section-margin">
        <div class="container">
            <div class="section-intro pb-85px text-center">
                <h2 class="section-intro__title">{{ __('website.server_packages_title') }}</h2>
                <p class="section-intro__subtitle">{{ __('website.server_packages_description') }}</p>
            </div>

            <div class="row">
                @foreach ($serversPackages as $package)
