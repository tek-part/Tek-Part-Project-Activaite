...
return [
    ...
    'backup' => [
        ...
        'destination' => [
             ...
             */
            'filename_prefix' => env('APP_NAME', 'clean-irq') . '-backup-',
            ...
            'disks' => [
                'local',
                // Add 's3' here if you want to store backups in the cloud
            ],
        ],
    ...
    'cleanup' => [
        ...
        'default_strategy' => [
             ...
             */
            'delete_oldest_backups_when_using_more_megabytes_than' => 10000, // 10GB
        ],
